        ...
        return (
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            <div className="space-y-4">
              <h1 className="text-6xl font-bold jackpot-text">STUDY CASINO</h1>
              <p className="text-2xl text-casino-gold">Where Every Study Session is a Jackpot! 🎰</p>
          ...
          <div className="space-y-8">
            <div className="text-center">
              <Button 
                ...
                variant="outline" 
                className="mb-6 border-casino-gold text-casino-gold hover:bg-casino-gold hover:text-primary-foreground"
              >
                ← Back to Home
              </Button>
            </div>
